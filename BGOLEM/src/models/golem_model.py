...
class GolemModel:
    ...
    def __init__(self, n, d, lambda_1,W, lambda_2, equal_variances=False,
                 seed=1, B_init=None):
        """Initialize self.
    ...
    def _build(self):
        ...
        self.W = self._preprocess(self.W)
    ...
    def _compute_L1_penalty(self):
        ...
        #m1 , m2, m3 = tf.linalg.svd( tf.math.multiply(self.B , self.W) )
	  
        #return tf.reduce_sum(m1)
        
		#print( tf.norm( tf.math.multiply(self.B , self.W) , ord=1) )
		
        return tf.norm( tf.math.multiply(self.B , self.W) , ord=1)
